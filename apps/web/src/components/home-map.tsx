          ...
          <MapMarker key={place.id} longitude={place.lng} latitude={place.lat}>
            <MarkerContent>
              <MarkerLabel position="top">
                <Badge className="bg-teal-color text-white rounded-sm font-normal">{place.label}</Badge>
              </MarkerLabel>
              <div className="size-5 rounded-full bg-teal-color border border-white shadow-lg cursor-pointer hover:scale-110 transition-transform" />
            </MarkerContent>
