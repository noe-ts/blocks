...
import { ArrowLeftToLineIcon, PanelLeftIcon } from "lucide-react";
		...
		>
			...
			<div
				...
				className={cn(
					...
					variant === "floating" || variant === "inset"
						? "pt-0 pr-2 pb-0 pl-0 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(--spacing(4))+2px)]"
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
	...
	return (
		<button
			...
			className={cn(
				"absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] after:opacity-0 after:transition-opacity after:duration-200 hover:after:bg-sidebar-border hover:after:bg-sidebar-border hover:after:opacity-100 group-data-[side=left]:-right-4 group-data-[side=right]:left-0 sm:flex",
